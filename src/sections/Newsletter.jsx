      ...
      gsap.fromTo(
        ...
        { y: 50, opacity: 0, },
        {
          scrollTrigger: {
            ...
            start: "top 80%",// Start the animation when the top of the newsletter is 80% from the top of the viewport
  ...
  return (
    <div className='bg-[#ECF5FE] py-16 md:py-32' ref={newsletterRef}>
      <div className='container max-w-[730px]'>
        <h2 ref={titleRef} className='text-2xl md:text-3xl lg:text-5xl leading-tight font-bold text-center'>Let’s Connect & Build Something Great Together!</h2>
        <p ref={descriptionRef} className='text-center font-medium lg:text-lg capitalize mt-4'>Whether you need IT consulting, custom solutions, or technical support, our team is ready to assist you. Let’s discuss how we can help your business grow!</p>
        <form ref={formRef} action="" className='font-medium flex md:items-center mt-9 flex-col md:flex-row'>
