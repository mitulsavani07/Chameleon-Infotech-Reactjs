...
const Footer = () => {
  ...
  return (
    <footer ref={footerRef} className="py-11 md:pt-24 md:pb-11">
      <div className="container">
        <div className="flex flex-wrap">
          ...
          {/* bottom content */}
          <div className="border-t border-[#4444442f] w-full mt-12 footer-items flex leading-[100%] justify-center lg:justify-between items-center flex-wrap">
            <p className="w-full lg:w-1/3 pt-5 lg:text-left text-center">
              {new Date().getFullYear()} © Chameleon. All rights reserved.
            </p>
            <ul className="flex items-center gap-4 w-full lg:w-1/3 justify-center pt-5">
